  ...
  describe('the return value of the function indicates wether the property was defined successfully', function() {
    describe('returns true', function() {
      it('when the property was created (which requires the 3rd parameter too!!!)', function() {
        ...
        const wasPropertyDefined = Reflect.defineProperty(instance, 'show', {value: () => {}});
    ...
    // https://github.com/tddbin/katas/issues/25#issuecomment-243567049
    // this test is not setup properly ( the second and third param of Reflect.defineProperty can never be omitted )
